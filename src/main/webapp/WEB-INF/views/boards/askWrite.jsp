...
<script>
	function validate(){ //글 양식이 일치하지 않으면 유효하지 않은 형식이므로 글 등록을 막을 수 있음.
                            ...
                            <div class="tab-pane fade" id="list-profile" role="tabpanel" aria-labelledby="list-profile-list"></div>
                                        ...
                                        <div class="tab-pane fade show active" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
                                            <h7 style="display: flex; justify-content: center;">문의하기</h7>
                                                ...
                                                <!--1:1문의 입력 폼-->
                            								  <form id = "content" name = "content" action="insertAskWrite" method="post" onsubmit="validate(), Alertting();" novalidate="novalidate"> 
