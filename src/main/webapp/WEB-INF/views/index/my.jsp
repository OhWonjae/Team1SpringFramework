        ...
        <br/>
            <div class="row">
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list"><br><h5><strong>나의 정보</strong></h5>
...
<<<<<<< HEAD
<<<<<<< HEAD
                                <div class="event"><button style="margin-left: 10px;" onclick="<%=application.getContextPath()%>/index/main' "type="button" class="btn btn-outline-secondary btn-sm">로그아웃</button></div>
=======
=======
                            ...
                            <table class="table";>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td> <img src="..\photo\/rank_photo/photo31.jpg" width="20%" style="float: left; margin-right: 10px;">
                                        ...
                                        <tr>
                                            ...
                                            <td> <img src="..\photo\/rank_photo/photo32.jpg" width="20%" style="float: left; margin-right: 10px;">
